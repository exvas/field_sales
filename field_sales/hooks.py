...
app_publisher = "vijila@teambackoffice.com"
app_description = "field sales"
app_email = "vijila@teambackoffice.com"
app_license = "mit"
...
app_include_js = ["/assets/field_sales/js/hide_add_multiple.js"]
